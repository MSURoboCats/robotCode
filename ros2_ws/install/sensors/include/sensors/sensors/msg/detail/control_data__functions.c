...
sensors__msg__ControlData__init(sensors__msg__ControlData * msg)
{
  ...
  if (!sensor_msgs__msg__Imu__init(&msg->imu_data)) {
    sensors__msg__ControlData__fini(msg);
    return false;
  }
  // depth
  return true;
...
sensors__msg__ControlData__create()
{
  ...
  sensors__msg__ControlData * msg = (sensors__msg__ControlData *)allocator.allocate(sizeof(sensors__msg__ControlData), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sensors__msg__ControlData));
  bool success = sensors__msg__ControlData__init(msg);
  if (!success) {
...
sensors__msg__ControlData__Sequence__init(sensors__msg__ControlData__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensors__msg__ControlData * data = NULL;

  if (size) {
    data = (sensors__msg__ControlData *)allocator.zero_allocate(size, sizeof(sensors__msg__ControlData), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sensors__msg__ControlData__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sensors__msg__ControlData__fini(&data[i - 1]);
      }
...
sensors__msg__ControlData__Sequence__fini(sensors__msg__ControlData__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sensors__msg__ControlData__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensors__msg__ControlData__Sequence * array = (sensors__msg__ControlData__Sequence *)allocator.allocate(sizeof(sensors__msg__ControlData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sensors__msg__ControlData__Sequence__init(array, size);
  if (!success) {
...
sensors__msg__ControlData__Sequence__destroy(sensors__msg__ControlData__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sensors__msg__ControlData__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sensors__msg__ControlData__Sequence__are_equal(const sensors__msg__ControlData__Sequence * lhs, const sensors__msg__ControlData__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sensors__msg__ControlData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sensors__msg__ControlData__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sensors__msg__ControlData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensors__msg__ControlData * data =
      (sensors__msg__ControlData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sensors__msg__ControlData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sensors__msg__ControlData__fini(&output->data[i]);
        }
        return false;
      }
    }
