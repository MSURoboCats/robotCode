...
#ifndef SENSORS__MSG__DETAIL__ENVIRONMENT_DATA__STRUCT_HPP_
#define SENSORS__MSG__DETAIL__ENVIRONMENT_DATA__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sensors__msg__EnvironmentData __attribute__((deprecated))
#else
# define DEPRECATED__sensors__msg__EnvironmentData __declspec(deprecated)
#endif
...
struct EnvironmentData_
{
  ...
  using ConstRawPtr =
    const sensors::msg::EnvironmentData_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sensors::msg::EnvironmentData_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sensors::msg::EnvironmentData_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sensors::msg::EnvironmentData_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sensors::msg::EnvironmentData_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sensors::msg::EnvironmentData_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sensors::msg::EnvironmentData_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sensors::msg::EnvironmentData_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sensors__msg__EnvironmentData
    std::shared_ptr<sensors::msg::EnvironmentData_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sensors__msg__EnvironmentData
    std::shared_ptr<sensors::msg::EnvironmentData_<ContainerAllocator> const>
...
using EnvironmentData =
  sensors::msg::EnvironmentData_<std::allocator<void>>;
...
#endif  // SENSORS__MSG__DETAIL__ENVIRONMENT_DATA__STRUCT_HPP_
