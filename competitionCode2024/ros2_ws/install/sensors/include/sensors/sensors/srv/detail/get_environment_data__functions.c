...
sensors__srv__GetEnvironmentData_Request__create()
{
  ...
  sensors__srv__GetEnvironmentData_Request * msg = (sensors__srv__GetEnvironmentData_Request *)allocator.allocate(sizeof(sensors__srv__GetEnvironmentData_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sensors__srv__GetEnvironmentData_Request));
  bool success = sensors__srv__GetEnvironmentData_Request__init(msg);
  if (!success) {
...
sensors__srv__GetEnvironmentData_Request__destroy(sensors__srv__GetEnvironmentData_Request * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    sensors__srv__GetEnvironmentData_Request__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
sensors__srv__GetEnvironmentData_Request__Sequence__init(sensors__srv__GetEnvironmentData_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensors__srv__GetEnvironmentData_Request * data = NULL;

  if (size) {
    data = (sensors__srv__GetEnvironmentData_Request *)allocator.zero_allocate(size, sizeof(sensors__srv__GetEnvironmentData_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sensors__srv__GetEnvironmentData_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sensors__srv__GetEnvironmentData_Request__fini(&data[i - 1]);
      }
...
sensors__srv__GetEnvironmentData_Request__Sequence__fini(sensors__srv__GetEnvironmentData_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sensors__srv__GetEnvironmentData_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensors__srv__GetEnvironmentData_Request__Sequence * array = (sensors__srv__GetEnvironmentData_Request__Sequence *)allocator.allocate(sizeof(sensors__srv__GetEnvironmentData_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sensors__srv__GetEnvironmentData_Request__Sequence__init(array, size);
  if (!success) {
...
sensors__srv__GetEnvironmentData_Request__Sequence__destroy(sensors__srv__GetEnvironmentData_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sensors__srv__GetEnvironmentData_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sensors__srv__GetEnvironmentData_Request__Sequence__are_equal(const sensors__srv__GetEnvironmentData_Request__Sequence * lhs, const sensors__srv__GetEnvironmentData_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sensors__srv__GetEnvironmentData_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sensors__srv__GetEnvironmentData_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sensors__srv__GetEnvironmentData_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensors__srv__GetEnvironmentData_Request * data =
      (sensors__srv__GetEnvironmentData_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sensors__srv__GetEnvironmentData_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sensors__srv__GetEnvironmentData_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sensors__srv__GetEnvironmentData_Request__copy(
...
sensors__srv__GetEnvironmentData_Response__init(sensors__srv__GetEnvironmentData_Response * msg)
{
  ...
  // data
  if (!sensors__msg__EnvironmentData__init(&msg->data)) {
    sensors__srv__GetEnvironmentData_Response__fini(msg);
    return false;
  }
  return true;
}
...
sensors__srv__GetEnvironmentData_Response__fini(sensors__srv__GetEnvironmentData_Response * msg)
{
  ...
  // data
  sensors__msg__EnvironmentData__fini(&msg->data);
}
...
sensors__srv__GetEnvironmentData_Response__are_equal(const sensors__srv__GetEnvironmentData_Response * lhs, const sensors__srv__GetEnvironmentData_Response * rhs)
{
  ...
  // data
  if (!sensors__msg__EnvironmentData__are_equal(
      &(lhs->data), &(rhs->data)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensors__srv__GetEnvironmentData_Response * msg = (sensors__srv__GetEnvironmentData_Response *)allocator.allocate(sizeof(sensors__srv__GetEnvironmentData_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sensors__srv__GetEnvironmentData_Response));
  bool success = sensors__srv__GetEnvironmentData_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
sensors__srv__GetEnvironmentData_Response__Sequence__init(sensors__srv__GetEnvironmentData_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensors__srv__GetEnvironmentData_Response * data = NULL;

  if (size) {
    data = (sensors__srv__GetEnvironmentData_Response *)allocator.zero_allocate(size, sizeof(sensors__srv__GetEnvironmentData_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sensors__srv__GetEnvironmentData_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        sensors__srv__GetEnvironmentData_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
sensors__srv__GetEnvironmentData_Response__Sequence__fini(sensors__srv__GetEnvironmentData_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      sensors__srv__GetEnvironmentData_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  sensors__srv__GetEnvironmentData_Response__Sequence * array = (sensors__srv__GetEnvironmentData_Response__Sequence *)allocator.allocate(sizeof(sensors__srv__GetEnvironmentData_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = sensors__srv__GetEnvironmentData_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
sensors__srv__GetEnvironmentData_Response__Sequence__destroy(sensors__srv__GetEnvironmentData_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    sensors__srv__GetEnvironmentData_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
sensors__srv__GetEnvironmentData_Response__Sequence__are_equal(const sensors__srv__GetEnvironmentData_Response__Sequence * lhs, const sensors__srv__GetEnvironmentData_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sensors__srv__GetEnvironmentData_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  sensors__srv__GetEnvironmentData_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sensors__srv__GetEnvironmentData_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    sensors__srv__GetEnvironmentData_Response * data =
      (sensors__srv__GetEnvironmentData_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sensors__srv__GetEnvironmentData_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          sensors__srv__GetEnvironmentData_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!sensors__srv__GetEnvironmentData_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
