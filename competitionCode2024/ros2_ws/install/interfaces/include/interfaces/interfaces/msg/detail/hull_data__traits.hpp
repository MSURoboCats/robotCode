...
#ifndef INTERFACES__MSG__DETAIL__HULL_DATA__TRAITS_HPP_
#define INTERFACES__MSG__DETAIL__HULL_DATA__TRAITS_HPP_
...
inline std::string to_yaml(const HullData & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const interfaces::msg::HullData & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const interfaces::msg::HullData & msg)
{
  return interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<interfaces::msg::HullData>()
{
  return "interfaces::msg::HullData";
}

template<>
inline const char * name<interfaces::msg::HullData>()
{
  return "interfaces/msg/HullData";
}

template<>
struct has_fixed_size<interfaces::msg::HullData>
...
template<>
struct has_bounded_size<interfaces::msg::HullData>
...
template<>
struct is_message<interfaces::msg::HullData>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // INTERFACES__MSG__DETAIL__HULL_DATA__TRAITS_HPP_
