...
bool
interfaces__msg__ControlData__are_equal(const interfaces__msg__ControlData * lhs, const interfaces__msg__ControlData * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
interfaces__msg__ControlData__copy(
  const interfaces__msg__ControlData * input,
  interfaces__msg__ControlData * output)
{
  if (!input || !output) {
    return false;
  }
...
interfaces__msg__ControlData__create()
{
  ...
  interfaces__msg__ControlData * msg = (interfaces__msg__ControlData *)allocator.allocate(sizeof(interfaces__msg__ControlData), allocator.state);
  if (!msg) {
    return NULL;
  }
...
interfaces__msg__ControlData__Sequence__init(interfaces__msg__ControlData__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interfaces__msg__ControlData *)allocator.zero_allocate(size, sizeof(interfaces__msg__ControlData), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  interfaces__msg__ControlData__Sequence * array = (interfaces__msg__ControlData__Sequence *)allocator.allocate(sizeof(interfaces__msg__ControlData__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
interfaces__msg__ControlData__Sequence__are_equal(const interfaces__msg__ControlData__Sequence * lhs, const interfaces__msg__ControlData__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!interfaces__msg__ControlData__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
interfaces__msg__ControlData__Sequence__copy(
  const interfaces__msg__ControlData__Sequence * input,
  interfaces__msg__ControlData__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(interfaces__msg__ControlData);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    interfaces__msg__ControlData * data =
      (interfaces__msg__ControlData *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interfaces__msg__ControlData__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          interfaces__msg__ControlData__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!interfaces__msg__ControlData__copy(
